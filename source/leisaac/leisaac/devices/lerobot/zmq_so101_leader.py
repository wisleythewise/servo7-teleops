...
"""
python scripts/environments/teleoperation/teleop_se3_agent.py --task=LeIsaac-SO101-ZeroShot-v0 --enable_cameras --teleop_device=zmq-so101leader --num_envs=1 --device=cpu --record --dataset_file=./datasets/marketing.hdf5
